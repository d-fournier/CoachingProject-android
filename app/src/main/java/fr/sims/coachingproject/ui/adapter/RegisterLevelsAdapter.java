...
public class RegisterLevelsAdapter extends ArrayAdapter {
    ...
    private final String NO_SPORT_SELECTED="Select sport";
    private final String NO_LEVEL_SELECTED="Select level";

    private OnSportChangedListener mListener;

    public RegisterLevelsAdapter(Context context, OnSportChangedListener listener) {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(previousSport==null || previousSport.mIdDb!=sport.mIdDb){
                    ...
                    if(sport.mIdDb!=-1){
                        ...
                        // No sport selected
                        List<SportLevel> noLevels=new ArrayList<SportLevel>();
